...
/** BlueBack.Mouse.Editor
*/
#if(UNITY_EDITOR)
namespace BlueBack.Mouse.Editor
{
	/** UpdatePackage
	*/
	public static class UpdatePackage
	{
		...
		*/
		...
		[UnityEditor.MenuItem("BlueBack/Mouse/UpdatePackage/Develop")]
		#endif
		public static void MenuItem_UpdatePackage_Develop()
		{
			UnityEditor.PackageManager.Client.Add("https://github.com/bluebackblue/UpmMouse.git?path=BlueBackMouse/Assets/UPM");
		}

		/** MenuItem_UpdatePackage_Last
		*/
		#if(!DEF_USER_BLUEBACK_MOUSE)
		[UnityEditor.MenuItem("BlueBack/Mouse/UpdatePackage/Last " + Version.packageversion)]
		#endif
		public static void MenuItem_UpdatePackage_Last()
		{
			string t_version = GetLastReleaseNameFromGitHub();
			if(t_version != null){
				UnityEditor.PackageManager.Client.Add("https://github.com/bluebackblue/UpmMouse.git?path=BlueBackMouse/Assets/UPM#" + t_version);
			}
		}
		...
		*/
		...
		{
			string t_url = "https://api.github.com/repos/bluebackblue/UpmMouse/releases/latest";
